import { WeaponPerkInfoFromApiSchema } from "@/lib/types/zodSchemasForApi/WeaponPerkInfo";
import { baseUrlBungieApi } from "./commonValues";
import { WeaponPerkInfo } from "@/lib/types/zodSchemasForDatabase/weaponPerkInfo";
